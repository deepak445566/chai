      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-6 sm:mb-8">
            ...
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#422006] font-serif mb-2">
              ...
              <p className="text-[#422006]/80 text-sm sm:text-base mt-2">
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 bg-gradient-to-r from-amber-400/30 to-amber-600/30 rounded-full blur-sm"></div>
          
            <div className="relative px-5 py-2.5 sm:px-6 sm:py-3 bg-gradient-to-r from-[#422006]/90 to-[#5a2e0a]/95 backdrop-blur-sm rounded-full shadow-lg border border-amber-500/30">
              <span className="text-amber-50 font-medium text-sm sm:text-base flex items-center">
