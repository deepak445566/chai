            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                 ...
                 {/* Glass/Transparent Cup Style */}
<div className="relative bg-gradient-to-b from-amber-50/10 via-amber-100/5 to-amber-50/20 rounded-full aspect-square shadow-2xl overflow-hidden border-2 border-amber-300/30 backdrop-blur-sm">
  {/* Glass Thickness/Edge */}
  <div className="absolute inset-2 rounded-full border-4 border-amber-200/20"></div>
  
  {/* Glass Reflections */}
  <div className="absolute top-4 right-4 w-12 h-12 bg-gradient-to-br from-white/30 to-transparent rounded-full blur-sm"></div>
  <div className="absolute bottom-4 left-4 w-8 h-8 bg-gradient-to-br from-white/20 to-transparent rounded-full blur-sm"></div>
  
  {/* Chai Liquid (Visible through glass) */}
  <div className="absolute top-1/3 left-2 right-2 bottom-2 bg-gradient-to-b from-amber-800/90 via-amber-700/85 to-[#5a2e0a] rounded-t-3xl">
    {/* Layered Chai Effect */}
    <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-amber-100/40 to-transparent rounded-t-3xl">
      {/* Milk Froth */}
      <div className="absolute top-1 left-1/4 w-6 h-3 bg-amber-50/50 rounded-full blur-xs"></div>
      <div className="absolute top-2 right-1/3 w-4 h-2 bg-amber-50/40 rounded-full blur-xs"></div>
    </div>
    
    {/* Tea Concentrate at Bottom */}
    <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-[#422006] to-transparent"></div>
    
    {/* Spice Sediments */}
    <div className="absolute bottom-4 left-1/4 w-8 h-1 bg-amber-900/60 rounded-full transform rotate-12"></div>
    <div className="absolute bottom-6 right-1/3 w-6 h-1 bg-amber-900/50 rounded-full transform -rotate-6"></div>
    ...
    <div className="absolute inset-0">
      {[...Array(12)].map((_, i) => (
        <div 
          key={i}
          className="absolute w-1 h-1 bg-amber-900/40 rounded-full animate-float"
          style={{
  ...
  <div className="absolute inset-0">
    {[...Array(15)].map((_, i) => (
      <div 
        key={i}
        className="absolute w-2 h-3 bg-gradient-to-b from-amber-50/20 to-transparent rounded-b-full blur-xs"
        style={{
  ...
  {/* Enhanced Steam */}
  <div ref={steamRef} className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-10">
    <div className="flex space-x-1">
      {[1, 2, 3].map((i) => (
        <div 
          ...
          className="relative"
          style={{
            animation: `steamRise ${2.5 + i * 0.2}s infinite ease-out ${i * 0.3}s`
          }}
        >
          <div className="w-4 h-16 bg-gradient-to-t from-amber-50/70 via-amber-100/40 to-transparent rounded-full blur-md"></div>
          {/* Steam expansion */}
          <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-6 h-4 bg-amber-50/30 rounded-full blur-sm"></div>
          <div className="absolute top-6 left-1/2 transform -translate-x-1/2 w-8 h-3 bg-amber-50/20 rounded-full blur-sm"></div>
        </div>
      ))}
    </div>
    
    {/* Scent Lines */}
    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-transparent via-amber-300/15 to-transparent blur-sm"></div>
  </div>
  
  {/* Cup Base/Stand */}
  <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-3/4 h-3 bg-gradient-to-t from-amber-800/30 to-transparent rounded-full blur-sm"></div>
</div>
