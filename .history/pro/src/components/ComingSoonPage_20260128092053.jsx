      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-6 sm:mb-8">
            ...
            >
              <h2 className="text-4xl font-bold text-[#422006] font-serif mb-2">
                <span className="block text-amber-600">Brew the
                 className="block bg-gradient-to-r from-amber-600 via-amber-500 to-amber-700 bg-clip-text text-transparent">
                  Royal Tradition
                </span>
              </h2>
              <p className="text-[#422006]/80 text-sm sm:text-base mt-2 pr">
