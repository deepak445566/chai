      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        >
          ...
          <div className="relative mb-2">
                ...
                <h1 className='text-4xl  lg:text-9xl ab  '>Launching Soon</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                  ...
                  {/* Spices */}
                  <div className="absolute -bottom-8 lg:bottom-10 left-0 lg:-left-24">
                    <div 
                      ref={el => spicesRef.current[0] = el}
                      className="w-25 h-25 sm:w-32 sm:h-32 rounded-full   flex items-center justify-center"
                    >
                      <img src='/images/cinn.png' className='bg-transparent'/>
                    </div>
                  </div>
                  
                  <div className="absolute -top-10 right-2 lg:-right-6">
                    <div 
                      ref={el => spicesRef.current[1] = el}
                      className="w-29 h-25 sm:w-35 sm:h-35 rounded-full   flex items-center justify-center"
                    >
                      <img src='/images/ginger3.png' className='bg-transparent'/>
                    </div>
                  </div>
                  
                  <div className="absolute -bottom-2 lg:bottom-8 -right-5 lg:-right-20">
                    <div 
                      ref={el => spicesRef.current[2] = el}
                      className="w-20 h-20 sm:w-27 sm:h-27 rounded-full   flex items-center justify-center"
                    >
            ...
            {/* Social Proof */}
            <div className="bg-gradient-to-br from-amber-50/50 to-amber-100/30 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-amber-200/30 mb-8 ab">
