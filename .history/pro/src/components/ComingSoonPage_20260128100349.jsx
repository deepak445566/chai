            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                 ...
                 {/* Minimalist Pure Chai Cup */}
<div className="relative w-60 h-60 sm:w-72 sm:h-72 rounded-full shadow-xl overflow-hidden border-3 border-amber-300/30 mx-auto">
  
  {/* Simple Cup */}
  <div className="absolute inset-0 bg-gradient-to-b from-amber-800 to-amber-950 rounded-full">
    
    {/* Milk Layer */}
    <div className="absolute top-0 left-0 right-0 h-1/4 bg-gradient-to-b from-amber-100/40 to-transparent rounded-t-full">
      {/* Simple Foam */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-amber-50/30 rounded-full blur-sm"></div>
    </div>
    
    {/* Tea Body */}
    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-amber-900 to-amber-950 rounded-full">
      {/* Simple Steam */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="w-8 h-8 bg-gradient-to-b from-amber-50/40 to-transparent rounded-full blur-sm animate-pulse"></div>
      </div>
    </div>
    
    {/* Cup Rim */}
    <div className="absolute inset-0 rounded-full border-6 border-amber-200/40"></div>
  </div>
  
  {/* Simple Handle */}
  <div className="absolute -right-6 top-1/2 transform -translate-y-1/2 w-6 h-24 bg-amber-300/30 rounded-l-lg"></div>
</div>
