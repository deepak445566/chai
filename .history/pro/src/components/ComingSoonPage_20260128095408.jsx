...
<div className="relative bg-gradient-to-b from-[#8B4513] via-[#A0522D] to-[#654321] rounded-full aspect-square shadow-2xl overflow-hidden border-4 border-[#5D4037]/60">
  {/* Terracotta Texture */}
  <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M20,20 Q40,15 60,20 T80,20 T60,40 T80,60 T60,80 T40,85 T20,80 T10,60 T20,40 T10,20 T20,20" fill="none" stroke="%235D4037" stroke-width="1" opacity="1"></div>
