...
<div className="relative bg-gradient-to-b from-[#8B4513] via-[#A0522D] to-[#654321] rounded-full aspect-square shadow-2xl overflow-hidden border-4 border-[#5D4037]/60">
  ...
  {/* Crack/Texture Lines */}
  <div className="absolute top-1/4 left-1/4 w-1/2 h-px bg-[#5D4037]/35 rounded-full transform rotate-12"></div>
  <div className="absolute top-1/3 right-1/3 w-1/3 h-px bg-[#5D4037]/35 rounded-full transform -rotate-6"></div>
