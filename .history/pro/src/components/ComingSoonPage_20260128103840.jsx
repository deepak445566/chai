      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        >
          ...
          <div className="relative mb-2">
                ...
                <h1 className='text-4xl md:text-8xl lg:text-9xl ab  '>Launching Soon</h1>
            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                  ...
                  {/* Spices */}
                  <div className="absolute -bottom-8 lg:bottom-10 left-0 md:-left-15 lg:-left-24">
                    <div 
                      ref={el => spicesRef.current[0] = el}
                      className="w-25 h-25 md:w-29 md:h-29 lg:w-32 lg:h-32 rounded-full   flex items-center justify-center"
                    >
                      <img src='/images/cinn.png' className='bg-transparent'/>
                    </div>
                  </div>
                  
                  <div className="absolute -top-10 right-2 md:-right-10 lg:-right-7">
                    <div 
                  ...
                  <div className="absolute -bottom-2 lg:bottom-8 -right-5 md:-right-15 lg:-right-20">
                    <div 
