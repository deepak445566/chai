            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                 ...
                 {/* Kulhad Body */}
<div className="relative 
  bg-[radial-gradient(circle_at_30%_30%,#6b3a14,#3a1a06)]
...
">
  ...
  {/* Rim / Mouth */}
  <div className="absolute top-2 left-3 right-3 h-4 
    bg-gradient-to-b from-[#8a4a1a] to-[#4a2208]
    rounded-full
    shadow-inner"
  />

  {/* Tea Liquid */}
  <div className="absolute top-[35%] left-4 right-4 h-[45%] 
    bg-[radial-gradient(circle_at_50%_20%,#d97706,#5a2e0a)]
    rounded-t-full
    shadow-inner"
  />

  {/* Tea Reflection */}
  <div className="absolute top-[38%] left-10 right-10 h-6 
