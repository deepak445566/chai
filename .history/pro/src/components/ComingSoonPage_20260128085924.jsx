...
const ComingSoonPage = () => {
  ...
  useEffect(() => {
    ...
    // Launching Soon animation (bigger and more prominent)
    tl.fromTo(launchingRef.current,
    ...
    // Pulsing animation for Launching Soon badge
    gsap.to(launchingRef.current, {
      scale: 1.05,
      duration: 1.5,
      repeat: -1,
      yoyo: true,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        {/* Hero Section - Correct Structure */}
        <div 
          ref={heroRef}
        ...
        >
          ...
          >
            ...
            <div className="relative mb-4">
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full blur-md opacity-60"></div>
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center shadow-2xl border-4 border-amber-300/50">
                  <span className="text-amber-50 font-bold text-3xl sm:text-4xl font-serif">RC</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl font-bold text-[#422006] font-serif mb-2">
                Royal Chai
              </h1>
              <div className="h-1 w-24 bg-gradient-to-r from-amber-500 to-amber-700 mx-auto mt-2 rounded-full"></div>
            </div>
          </div>

          {/* Launching Soon Badge - LARGER and more prominent */}
          <div 
            ref={launchingRef}
            className="relative mb-8"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-amber-400/40 to-amber-600/40 rounded-full blur-md"></div>
            <div className="relative px-8 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-[#422006]/95 to-[#5a2e0a]/95 backdrop-blur-md rounded-full shadow-2xl border-2 border-amber-500/40">
              <span className="text-amber-50 font-bold text-lg sm:text-xl md:text-2xl flex items-center justify-center">
                <span className="relative flex h-4 w-4 mr-3">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-4 w-4 bg-amber-300"></span>
                </span>
                LAUNCHING SOON
              </span>
            </div>
          ...
          {/* Tagline Section - Fixed Structure */}
          <div 
            ref={taglineRef}
            className="text-center mb-6"
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#422006] font-serif mb-3">
              <span className="block text-amber-600">Brew the</span>
              <span className="block bg-gradient-to-r from-amber-600 via-amber-500 to-amber-700 bg-clip-text text-transparent mt-2">
                Royal Tradition
              </span>
            </h2>
            
            {/* Description Line */}
            <p className="text-[#422006]/80 text-base sm:text-lg md:text-xl mt-4 max-w-2xl mx-auto">
            ...
            <div className="relative mb-8">
              ...
              >
                ...
                <div className="relative mx-auto max-w-xs sm:max-w-sm">
                  ...
                  {/* Cup Body */}
                  <div className="relative bg-gradient-to-b from-[#422006]/90 to-[#5a2e0a]/95 rounded-full aspect-square shadow-2xl overflow-hidden border border-amber-600/30">
                    {/* Liquid Surface */}
                    <div className="absolute top-1/2 left-0 right-0 h-1/2 bg-gradient-to-b from-amber-700/80 to-[#422006]/90 rounded-t-full"></div>
                    
                    {/* Tea Pattern */}
                    <div className="absolute inset-8 rounded-full border-4 border-amber-600/20"></div>
                    <div className="absolute inset-12 rounded-full border-2 border-amber-500/10"></div>
                  ...
                  <div className="absolute -bottom-3 -left-3">
                    <div 
                      ...
                      className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 shadow-lg border border-amber-400/30 flex items-center justify-center"
                    >
                      <span className="text-amber-50 text-xs sm:text-sm font-bold">Cardamom</span>
                    </div>
                  </div>
                  ...
                  <div className="absolute -top-3 right-4">
                    <div 
                      ...
                      className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-amber-600 to-amber-800 shadow-lg border border-amber-500/30 flex items-center justify-center"
                    >
                      <span className="text-amber-50 text-xs font-bold">Ginger</span>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-8 -right-3">
                    <div 
                      ...
                      className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-amber-700 to-amber-900 shadow-lg border border-amber-600/30 flex items-center justify-center"
                    >
                      <span className="text-amber-50 text-xs font-bold">Cinnamon</span>
                    </div>
                  </div>
                </div>
              </div>
